...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SafeBox — Daily Savings for Market Traders" },
      { property: "og:description", content: "Save daily through trusted agent banking. CBN compliant. Instant SMS receipts. Earn up to 10% annually." },
